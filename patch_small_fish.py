...
target = """          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" className="drop-shadow-md">
            <defs>
              <clipPath id="koi-body">
                <path d="M 4 12 C 4 8, 12 6, 18 12 C 12 18, 4 16, 4 12 Z" />
              </clipPath>
            </defs>
            {/* Tail */}
            <path d="M 4 12 L 0 8 L 2 12 L 0 16 Z" fill="#EA580C" />
            {/* Fins */}
            <path d="M 10 8 L 8 4 L 12 7 Z" className="fill-[#F8FAFC] dark:fill-[#CBD5E1]" opacity="0.9" />
            <path d="M 10 16 L 8 20 L 12 17 Z" className="fill-[#F8FAFC] dark:fill-[#CBD5E1]" opacity="0.9" />
            
            {/* Body Base */}
            <path d="M 4 12 C 4 8, 12 6, 18 12 C 12 18, 4 16, 4 12 Z" className="fill-[#F8FAFC] dark:fill-[#CBD5E1]" />
            
            {/* Patterns clipped to body */}
            <g clipPath="url(#koi-body)">
              <circle cx="9" cy="9" r="3.5" fill="#EA580C" />
              <circle cx="14" cy="14" r="4" fill="#1E293B" />
              <circle cx="16" cy="8" r="2.5" fill="#EA580C" />
              <circle cx="6" cy="13" r="2" fill="#1E293B" />
            </g>
            {/* Eyes */}
            <circle cx="15" cy="9.5" r="1" fill="#0F172A" />
            <circle cx="15" cy="14.5" r="1" fill="#0F172A" />
          </svg>"""
